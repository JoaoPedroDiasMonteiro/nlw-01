...
const CreatePoint = () => {
    ...
    const [seletectedPostion, setSeletectedPostion] = useState<[number, number]>([0, 0]);
    ...
    function handleMapClick(event: LeafletMouseEvent) {
        setSeletectedPostion([event.latlng.lat, event.latlng.lng])
    }
    ...
    async function handleSubmit(event: FormEvent) {
        ...
        const [latitude, longitude] = seletectedPostion;
            ...
            <form onSubmit={handleSubmit}>
                ...
                <fieldset>
                    ...
                    <div className="field">
                        ...
                        <input onChange={handleInputChange} type='text' name='name' id='name'></input>
                    </div>

                    <div className="field-group">
                        <div className="field">
                            <label htmlFor="email">E-mail</label>
                            <input onChange={handleInputChange} type='text' name='email' id='email'></input>
                        </div>
                        <div className="field">
                            <label htmlFor="whatsapp">Whatsapp</label>
                            <input onChange={handleInputChange} type='text' name='whatsapp' id='whatsapp'></input>
                        </div>
                    </div>
                ...
                <fieldset>
                    ...
                    <Map center={initialPosition} zoom={15} onclick={handleMapClick}>
                        ...
                        />
                        <Marker position={seletectedPostion}></Marker>
                    </Map>
